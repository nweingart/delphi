...
import QuotesScreen from '../explore/Quotes'
import MeditationsScreen from '../explore/Meditations'
import JournalsScreen from '../explore/Journals'
...
const Library = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      {selectedTab === 'Journal Entries' && <JournalsScreen />}
    </View>
  );
};
